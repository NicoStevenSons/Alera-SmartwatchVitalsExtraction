          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => SleepHistoryPage(sleepData: sleepData),
                ),
              );
            },
            child: const Padding(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('${todaySessions.length} sleep session(s) today'),

                const SizedBox(height: 8),

                Text('Start: ${_formatTime(start)}'),

                Text('End: ${_formatTime(end)}'),
